...
function validarCedula($CedulaDeIdentidad) {
	/*
		...
		Link al repositorio original: https://github.com/DiMaNacho/validarci
		Utilizado por DAMM FILE para comprobar la veracidad del CI Uruguayo.

		**ACLARACIÓN**

		Este código no es un plagio, ya que se dan los créditos correspondientes al autor original. 
		El código fue obtenido de un repositorio público en GitHub: DiMaNacho/validarci 
		y se usará para la realización del Proyecto de Egreso del año 2024 para el EMT INFORMÁTICA.
	*/
